...
def pilih_login():
    ...
    time.sleep(0.05)
    jalan ('\033[1;97m◣1◢\x1b[1;93mPhilipines')
    time.sleep(0.05)
...
def action():
	...
	if bch =='':
		...
		os.system("clear")
		print (logo2)
		print("\033[1;93m02, 0906,0915,0916,0917 ,0926 ,0927,0935,0936,0937,0945,0953,,0954,0955")
		try:
